...
![Debug Graphics Enabled for (1) Collision (2) Navigation Grid Occupancy (3) Navigation Waypoints](https://github.com/tmf7/Dont-Be-a-Hero/blob/master/graphics/DBaH_Debug_README.gif)

![Debug Graphics Disabled](https://github.com/tmf7/Dont-Be-a-Hero/blob/master/graphics/DBaH_NoDebug_README.gif)
